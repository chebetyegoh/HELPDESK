...
urlpatterns =[
    ...
    path('officer-change-password/',views.change_password_officer, name='officer-change-password'),
    ...
    path("studentdeleteview/<int:pk>/", views.AdminStudentdeleteview.as_view(),name='studentdeleteview'),
    path('admin-change-password/', views.change_password_admin, name='admin-change-password'),
